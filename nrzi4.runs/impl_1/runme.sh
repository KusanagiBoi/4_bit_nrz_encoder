...
HD_PWD='C:/SLP/4_bit_nrz_encoder/nrzi4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nrz4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nrz4.tcl -notrace
